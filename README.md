# arale-ocr-manga-anki

**あられブック（ARaLeBook）的 manga-anki OCR 引擎**：[manga-anki](https://github.com/heyanLE/arale-book)
之外单独一个仓库——因为它和主应用的发版节奏、平台、体积都完全不是一回事。
...
```bash
git clone <manga_anki>            # 需要它的 factory/.ocr-venv 与 factory/.models
cd arale-ocr-manga-anki
